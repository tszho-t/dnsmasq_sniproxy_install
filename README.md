...
### ARM安装：
``` Bash
wget --no-check-certificate -O dnsmasq_sniproxy_arm.sh https://raw.githubusercontent.com/tszho-t/dnsmasq_sniproxy_install/master/dnsmasq_sniproxy_arm.sh && bash dnsmasq_sniproxy_arm.sh -i
```
